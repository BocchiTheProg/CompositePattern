...
В цьому репозиторії ви можете побачити дві реалізації патерну:
1) коли Component - це class(знаходиться у гілці main);
2) коли Component - це module(знаходиться у гілці ModuleRealization).